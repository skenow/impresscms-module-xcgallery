...
function send_ecard($recipient_email, $recipient_name, $greetings, $msg_content, $sender_name, $sender_email, $image, $n_picname, $redirect_link) {
	...
	$xoopsMailer->setToEmails($recipient_email);
...
$icmsTpl->assign('ecard_title', _MD_CARD_TITLE);
$icmsTpl->assign('lang_ecard_from', _MD_CARD_FROM);
$icmsTpl->assign('thumb_url', $thumb_pic_url);
$icmsTpl->assign('album', $album);
$icmsTpl->assign('pid', $pid);
$icmsTpl->assign('pos', $pos);
$icmsTpl->assign('lang_your_name', _MD_CARD_YOUR_NAME);
$icmsTpl->assign('sender_name', $sender_name);
$icmsTpl->assign('lang_your_email', _MD_CARD_YOUR_EMAIL);
$icmsTpl->assign('sender_email', $sender_email);
$icmsTpl->assign('sender_email_warning', $sender_email_warning);
$icmsTpl->assign('lang_ecard_to', _MD_CARD_TO);
$icmsTpl->assign('lang_rcpt_name', _MD_CARD_RCPT_NAME);
$icmsTpl->assign('recipient_name', $recipient_name);
$icmsTpl->assign('lang_rcpt_email', _MD_CARD_RCPT_EMAIL);
$icmsTpl->assign('recipient_email', $recipient_email);
$icmsTpl->assign('recipient_email_warning', $recipient_email_warning);
$icmsTpl->assign('lang_ecard_greetings', _MD_CARD_GREETINGS);
$icmsTpl->assign('greetings', $greetings);
$icmsTpl->assign('lang_ecard_message', _MD_CARD_MESSAGE);
...
$icmsTpl->assign('xoops_codes', $msgArea->render());
