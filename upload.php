...
$icmsTpl->assign('xoops_codes', $picDescription->render());

$icmsTpl->assign('max_upl', sprintf(_MD_UPL_MAX_FSIZE, icms::$module->config['max_upl_size']));
$icmsTpl->assign('lang_upload', _MD_UPL_TITLE);
$icmsTpl->assign('lang_album', _MD_ALBUM);
$icmsTpl->assign('lang_picture', _MD_UPL_PICTURE);
$icmsTpl->assign('lang_picture_title', _MD_UPL_PIC_TITLE);
$icmsTpl->assign('lang_keywords', _MD_UPL_KEYWORDS);
$icmsTpl->assign('max_file_size', icms::$module->config['max_upl_size'] << 10);
$icmsTpl->assign('lang_options', "_MD_OPTIONS");
$icmsTpl->assign('lang_notify', "_MD_NOTIFYAPPROVE");
$icmsTpl->assign('lang_description', _MD_UPL_DESCRIPTION);
$icmsTpl->assign('lang_submit', _SUBMIT);
$icmsTpl->assign('lang_cancel', _CANCEL);
$icmsTpl->assign('lang_quote', _QUOTEC);
$icmsTpl->assign('album_selbox', form_alb_list_box());
