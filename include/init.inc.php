...
if (is_array($_POST)) {
	foreach ($_POST as $key => $value) {
		if (!is_array($value)) $_POST[$key] = $value;
...
$IMG_TYPES = array(1 => 'GIF', 2 => 'JPG', 3 => 'PNG', 4 => 'SWF', 5 => 'PSD', 6 => 'BMP', 7 => 'TIFF', 8 => 'TIFF', 9 => 'JPC', 10 => 'JP2', 11 => 'JPX', 12 => 'JB2', 13 => 'SWC', 14 => 'IFF');

$MOV_TYPES = array(1 => 'MPG', 2 => 'MPEG', 3 => 'WMV', 4 => 'QT', 5 => 'SWF', 6 => 'AVI', 7 => 'MOV');

$SND_TYPES = array(1 => 'MP3', 2 => 'MIDI', 3 => 'MID', 4 => 'WMA', 5 => 'WAV');

$DOC_TYPES = array(1 => 'DOC', 2 => 'TXT', 3 => 'RTF', 4 => 'PDF', 5 => 'XLS', 6 => 'PPT', 7 => 'ZIP', 8 => 'RAR');
